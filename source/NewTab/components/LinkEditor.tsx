...
export const LinkEditor: FC<LinkEditorProps> = ({ initialLink, onCancel, onSave, submitLabel, title }) => {
		...
		<form className={styles.linkEditor} onSubmit={handleSubmit}>
			...
			<div className={styles.editorGrid}>
				...
				<div className={styles.editorActions}>
					<button type="submit" className={styles.iconButton} aria-label={submitLabel} title={submitLabel}>
						<Check size={18} aria-hidden="true" />
					</button>
					<button type="button" className={styles.iconButton} onClick={onCancel} aria-label="Cancel" title="Cancel">
