...
export const ThemePicker: FC<ThemePickerProps> = ({ onThemeChange, selectedThemeId }) => {
	...
	return (
		<div className={styles.themePicker} ref={pickerRef}>
			<button type="button" className={styles.themeToggle} onClick={(): void => setIsOpen((currentValue) => !currentValue)} aria-label="Choose theme" aria-expanded={isOpen} title="Choose theme">
