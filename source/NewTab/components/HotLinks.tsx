...
export const HotLinks: FC<HotLinksProps> = ({ links, onAddLink, onDeleteLink, onUpdateLink }) => {
		...
		<section className={styles.hotLinks} aria-labelledby="hot-links-title">
			<div className={styles.sectionHeader}>
				...
				<div className={styles.headerActions}>
					...
					<button
						type="button"
						className={`${styles.iconButton} ${isManaging ? styles.iconButtonActive : ""}`}
						onClick={(): void => {
			...
			{isManaging && isAdding && <LinkEditor submitLabel="Save new link" title="New link" onCancel={(): void => setIsAdding(false)} onSave={handleCreate} />}

			{isManaging && editingLink && <LinkEditor initialLink={editingLink} submitLabel="Save link" title="Edit link" onCancel={(): void => setEditingLinkId(null)} onSave={handleUpdate} />}
